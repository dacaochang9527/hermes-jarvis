...
> 生成时间：2026-07-03 22:00 CST  
> 飞书在线文档：https://mcncgf38by7m.feishu.cn/docx/K5Zqd5omnoGOgVxA3O2cxSeRnId  
> 标的：PVC2609 期货合约  
> 触发来源：reports/pvc2609_20260703_intraday_night_2115_key_level_break_up_4470.md  
> 数据源：新浪期货公开 quote、3m/15m/30m K线、本地关键位状态  
> 数据状态：quote 返回 `2026-07-03 22:00:50`，现价 `4486`，quote 日期与交易日不一致：否  
...
|---|---|
| 触发时段 | 夜盘 |
| 触发时间 | 2026-07-03 22:03:00 |
| 触发价位 | 4485 |
| 触发类型 | key_level_break_up |
| 触发说明 | 3m收盘收回/上破 4485（修复延续确认位） |
| 触发后现价 | 4486 |
| 本时段第几份盘中文档 | 2/3 |
...
| 周期 | 区间 | 收盘/现价 | 量仓 | 解读 |
|---|---|---|---|---|
| 3m 本时段 | 4455-4490 | 4486 | 量 201077；持仓变化 976 | 入场触发周期，只看有效收线 |
| 15m 本时段 | 4455-4490 | 4486 | 量 179816；持仓变化 2072 | 判断触发是否有连续性 |
| 30m 本时段 | 4455-4490 | 4486 | 量 152896；持仓变化 -50 | 判断是否只是短线噪音 |
...
- 这次只说明 `3m收盘收回/上破 4485（修复延续确认位）` 已经发生，不代表必须立刻交易。
...
STATE_HANDOFF
contract: PVC2609
source_doc: reports/pvc2609_20260703_intraday_night_2200_key_level_break_up_4485.md
