...
> 生成时间：2026-07-17 21:24 CST  
> 飞书在线文档：https://mcncgf38by7m.feishu.cn/docx/IloDddOyLopPntxctKXcjENYnNg  
> 标的：PVC2609 期货合约  
> 触发来源：reports/pvc2609_20260717_intraday_night_2109_key_level_break_down_4460.md  
> 数据源：新浪期货公开 quote、3m/15m/30m K线、本地关键位状态  
> 数据状态：quote 返回 `2026-07-17 21:24:27`，现价 `4481`，quote 日期与交易日不一致：否  
...
|---|---|
| 触发时段 | 夜盘 |
| 触发时间 | 2026-07-17 21:27:00 |
| 触发价位 | 4480 |
| 触发类型 | key_level_break_up |
| 触发说明 | 3m收盘收回/上破 4480（重新修复确认位） |
| 触发后现价 | 4481 |
| 本时段第几份盘中文档 | 2/3 |
...
| 周期 | 区间 | 收盘/现价 | 量仓 | 解读 |
|---|---|---|---|---|
| 3m 本时段 | 4440-4491 | 4481 | 量 3517；持仓变化 -2872 | 入场触发周期，只看有效收线 |
| 15m 本时段 | 4440-4491 | 4480 | 量 1506；持仓变化 -3128 | 判断触发是否有连续性 |
| 30m 本时段 | 4440-4491 | 4481 | 量 715；持仓变化 0 | 判断是否只是短线噪音 |
...
- 这次只说明 `3m收盘收回/上破 4480（重新修复确认位）` 已经发生，不代表必须立刻交易。
...
STATE_HANDOFF
contract: PVC2609
source_doc: reports/pvc2609_20260717_intraday_night_2124_key_level_break_up_4480.md
