...
> 生成时间：2026-07-31 15:05 CST  
> 标的：PVC2609 期货合约  
> 触发来源：reports/pvc2609_20260731_intraday_afternoon_1421_key_level_break_up_4480.md  
> 数据源：新浪期货公开 quote、3m/15m/30m K线、本地关键位状态  
> 数据状态：quote 返回 `2026-07-31 15:04:19`，现价 `4480`，quote 日期与交易日不一致：否  
...
| 周期 | 区间 | 收盘/现价 | 量仓 | 解读 |
|---|---|---|---|---|
| 3m 本时段 | 4471-4489 | 4481 | 量 58859；持仓变化 -7110 | 入场触发周期，只看有效收线 |
| 15m 本时段 | 4464-4522 | 4481 | 量 349475；持仓变化 -16862 | 判断触发是否有连续性 |
| 30m 本时段 | 4464-4522 | 4477 | 量 279188；持仓变化 -8727 | 判断是否只是短线噪音 |
...
| 新关键位 | 类型 | 含义 | 再触发是否发文档 |
|---:|---|---|---|
| 4465 | support | 盘中近端支撑 | 是，受时段上限约束 |
| 4480 | midline | 盘中短线中轴 | 是，受时段上限约束 |
| 4495 | resistance | 盘中近端压力 | 是，受时段上限约束 |
...
STATE_HANDOFF
contract: PVC2609
source_doc: reports/pvc2609_20260731_intraday_healthcheck.md
