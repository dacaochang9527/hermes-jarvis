...
> 标的：PVC2609 期货合约  
> 触发来源：reports/pvc2609_20260804_intraday_night_2118_key_level_break_down_4455.md  
> 数据源：新浪期货公开 quote、3m/15m/30m K线、本地关键位状态  
> 数据状态：quote 返回 `2026-08-04 23:00:00`，现价 `4447`，quote 日期与交易日不一致：是  
...
| 周期 | 区间 | 收盘/现价 | 量仓 | 解读 |
|---|---|---|---|---|
| 3m 本时段 | 4446-4456 | 4450 | 量 55748；持仓变化 -6130 | 入场触发周期，只看有效收线 |
...
| 新关键位 | 类型 | 含义 | 再触发是否发文档 |
|---:|---|---|---|
| 4440 | support | 盘中近端支撑 | 是，受时段上限约束 |
| 4445 | midline | 盘中短线中轴 | 是，受时段上限约束 |
| 4450 | resistance | 盘中近端压力 | 是，受时段上限约束 |
